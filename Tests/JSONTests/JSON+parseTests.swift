...
class JSONParseTests: XCTestCase {
    ...
    func testUTF8() {
        assertThrows(try JSON.parse(bytes: [0x22, 0xC2]), "Invalid character at (1,2)")
        ...
        assertThrows(try JSON.parse(bytes: [0x22, 0xE2, 0x98]), "Invalid character at (1,2)")
        ...
        assertThrows(try JSON.parse(bytes: [0x22, 0xF0, 0x9D, 0x8C]), "Invalid character at (1,2)")
